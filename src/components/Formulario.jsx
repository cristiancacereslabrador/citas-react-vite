...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente}) => {
  ...
  const handleSubmit = (e) => {
    ...
    if([nombre, propietario, email, fecha, sintomas].includes('')){
      ...
      // console.log('hay un paci?  '+paciente.id)
      if(paciente.id)
      {   //Editando el registro 
          ...
          //  console.log('pacienteState: '+pacienteState)
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      ...
      <form
        ...
        <div className="mb-5">
          <label htmlFor="fechaIngreso" className="block text-gray-700 uppercase font-bold"
